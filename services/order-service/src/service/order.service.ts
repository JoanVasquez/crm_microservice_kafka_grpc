import { ICacheService, IMessagingService, IRepository, OrderCreatedEvent } from "shared";
    ...
    async createOrder(orderData: CreateOrderDto): Promise<Order> {
        ...
        const orderCreatedEvent: OrderCreatedEvent = {
            ...
            data: {
                ...
                totalAmount: createdOrder.items.reduce((total, item) => total + item.price * item.quantity, 0),
            },
        }
